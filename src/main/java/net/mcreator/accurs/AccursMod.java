...
@Mod("accurs")
public class AccursMod {
	public static final Logger LOGGER = LogManager.getLogger(AccursMod.class);
	public static final String MODID = "accurs";
