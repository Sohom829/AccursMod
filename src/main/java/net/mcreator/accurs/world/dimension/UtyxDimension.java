...
package net.mcreator.accurs.world.dimension;
...
public class UtyxDimension {
	...
	public static class Fixers {
		...
		public static void registerDimensionSpecialEffects(FMLClientSetupEvent event) {
			...
			event.enqueueWork(() -> DimensionSpecialEffects.EFFECTS.put(new ResourceLocation("accurs:utyx"), customEffect));
		}
	}
}
